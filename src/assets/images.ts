...
export const contactUsImage = `${publicImageUrl}/contact-us.jpg`;

export const carouselBannerImages = [
  `${publicImageUrl}/slider-1.jpg`,
  `${publicImageUrl}/slider-2.jpg`,
  `${publicImageUrl}/slider-3.jpg`,
  `${publicImageUrl}/slider-4.jpg`,
  `${publicImageUrl}/slider-5.jpg`,
  `${publicImageUrl}/slider-6.jpg`,
];
